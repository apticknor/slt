        ...
        <div class="section section_portfolio">
            <div class="section-hd">
                <h2 class="hdg hdg_section hdg_gray">We&rsquo;re passionate about solving complex user experience challenges.</h2>
            </div>
            <div class="section-bd">
                <div class="promo">
                    ...
                    <div class="promo-ft">
                        <p>We&rsquo;ve helped some of the top brands in the world.</p>
                        <ul class="partners">
